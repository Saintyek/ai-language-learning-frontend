---
name: adk-sdd-brainstorm
description: "Use when the user explicitly asks to brainstorm, explore ideas, or organize unclear requirements before formal specification; do not use for general coding requests or when the user already has a clear requirement."
---

# ADK SDD Brainstorm

This skill is an optional exploration-stage skill in SDD. It is suitable for brainstorming when requirements are unclear or the technical approach is not yet defined, helping organize ideas and produce a structured technical proposal.

## Manual Trigger Constraints

- Use this skill only when the user explicitly mentions brainstorm, brainstorming, exploring ideas, organizing thoughts, or explicitly names this skill.
- This is an optional stage, not a required step in the SDD workflow. Do not recommend this skill automatically based on artifact state.
- If the user already has a clear request, such as "help me write a spec" or "help me implement a feature," do not switch to this skill automatically.

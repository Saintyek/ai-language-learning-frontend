---
name: adk-sdd-archive
description: "Use when the user wants to archive old specs, move historical spec folders into `specs/archived/`, or update `specs/ARCHIVE.md`; do not use unless archival is explicitly requested."
---

# ADK SDD Archive

This skill is an SDD helper for archiving historical specification artifacts. It is suitable for organizing old spec directories and maintaining the archive index.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to archive old specs, organize historical spec directories, or maintain the archive index.
- This is a file-management action with deletion effects and must not be triggered implicitly.

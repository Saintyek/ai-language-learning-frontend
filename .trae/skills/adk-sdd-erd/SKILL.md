---
name: adk-sdd-erd
description: "Use when the user wants a technical design document, frontend or backend TDD, or deeper architecture detail based on existing SDD artifacts; do not use for direct coding requests."
---

# ADK SDD ERD

This skill is an SDD stage skill for generating technical design documents. It is suitable for producing frontend or backend TDDs based on existing design artifacts.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to generate a TDD, a technical design document, or a more detailed architectural description.
- If the user simply wants to continue coding, do not enter this skill automatically.

---
name: adk-sdd-constitution
description: "Use when the user wants to create or update the project constitution, change governance rules, or sync SDD templates and command constraints with new principles; do not use for ordinary coding or document editing."
---

# ADK SDD Constitution

This skill is an SDD stage skill for maintaining project governance rules. It is suitable for creating or updating the constitution and syncing related templates and command constraints.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to create or update the constitution, adjust governance rules, or sync related policy constraints.
- This is not ordinary document polishing. It is a governance-rules update flow.

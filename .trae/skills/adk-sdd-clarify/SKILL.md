---
name: adk-sdd-clarify
description: "Use when the user wants to clarify requirements, answer open questions, or sync existing SDD design documents after resolving ambiguity; do not use for ordinary coding requests."
---

# ADK SDD Clarify

This skill is an SDD stage skill for clarifying requirements and syncing design documents. It is suitable for resolving high-impact ambiguity through iterative question-and-answer exchanges.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to clarify requirements, answer key open questions, or sync existing design documents.
- This is a formal synchronization flow during the SDD design phase, not a general "add more explanation" action.

---
name: adk-sdd-specify
description: "Use when the user wants to turn a request into a spec, create or update `spec.md`, or enter the specification stage of the SDD workflow; do not use for general implementation requests."
---

# ADK SDD Specify

This skill is an SDD stage skill for writing and updating requirement specifications. It is suitable for turning natural-language requirements into `spec.md`.

## Manual Trigger Constraints

- Use this skill only when the user explicitly wants to write or expand a `spec`, organize requirement specifications, or enter the specification stage of SDD.
- If the user only says something general like "implement a feature," do not switch to this skill automatically.

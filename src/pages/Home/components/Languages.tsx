...
const Languages: React.FC = () => {
  ...
  const renderLanguageCard = (language: (typeof languageOptions)[number]) => (
    ...
    >
      <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[22px] border border-sky-100 bg-linear-to-br from-white via-sky-50 to-cyan-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.95),0_12px_28px_rgba(14,165,233,0.14)] transition-transform duration-300 group-hover:scale-105">
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,rgba(191,219,254,0.9),rgba(239,246,255,0.78)_36%,#f8fbff_68%,#eef4ff_100%)] py-36">
      ...
      <div className="relative container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-600">
            无论你想学习中文、日语、西班牙语还是英语，AI
            都能陪你进行真实场景的对话练习，让语言学习更高效有趣。
          </p>
        </div>
        ...
        <div className="mt-16 grid items-center gap-6 lg:grid-cols-[minmax(220px,1fr)_minmax(340px,520px)_minmax(220px,1fr)]">
          ...
          <div className="relative overflow-hidden rounded-[36px] border border-white/75 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.96),rgba(239,246,255,0.88)_55%,rgba(219,234,254,0.92)_100%)] px-8 py-12 text-center shadow-[0_30px_90px_rgba(37,99,235,0.16)] backdrop-blur-2xl">
            <div className="absolute inset-x-10 top-0 h-px bg-linear-to-r from-transparent via-sky-400/70 to-transparent" />
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-5 max-w-md text-base leading-7 text-slate-600">
                通过自然的 AI
                对话，在真实场景中练习语言，获得即时反馈和个性化指导，快速提升听说能力。
              </p>
